...
class AnalysisRun(Base):
    ...
    triggered_by = Column(String, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
...
class Notification(Base):
    ...
    related_finding_id = Column(String, ForeignKey("codesec_findings.id", ondelete="SET NULL"), nullable=True)
